<template>
  <div class="login">
    <van-nav-bar left-text="返回" left-arrow @click-left="back" right-text="先去书城" @click-right="goState('Books')">
    ...
    <div class="user-box">
      ...
      <van-form v-show="!isNext">
        ...
        <div class="commit-btn">
          <van-button @click="next" round block color="#23b383">
            下一步
          </van-button>
        </div>
      </van-form>
      ...
      <van-form v-show="isNext">
        ...
        <div class="commit-btn">
          <van-button round block color="#23b383" @click="commit">
            提交
          </van-button>
        </div>
        <div class="commit-btn">
          <van-button round block type="default" @click="goBack()">
            返回
          </van-button>
        </div>
      </van-form>
